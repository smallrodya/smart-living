    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#222" strokeWidth="1.3">
            <path d="M20 7h-3V4H7v3H4v14h16V7zM7 7h10M12 12v6M9 12v6M15 12v6"/>
          </svg>
          <span style={{ fontSize: 11, fontWeight: 600, color: '#222', lineHeight: 1.1, textAlign: 'center' }}>FREE SHIPPING</span>
          <span style={{ fontSize: 10, color: '#666', textAlign: 'center', lineHeight: 1.1 }}>All over the UK</span>
        </div>
        <div style={{
          width: '25%',
          display: 'flex',
          ...
          <span style={{ fontSize: 11, fontWeight: 600, color: '#222', lineHeight: 1.1, textAlign: 'center' }}>FREE RETURNS</span>
          <span style={{ fontSize: 10, color: '#666', textAlign: 'center', lineHeight: 1.1 }}>30-days free return policy.</span>
        </div>
        <div style={{
          width: '25%',
          display: 'flex',
          ...
          <span style={{ fontSize: 11, fontWeight: 600, color: '#222', lineHeight: 1.1, textAlign: 'center' }}>SECURED PAYMENTS</span>
          <span style={{ fontSize: 10, color: '#666', textAlign: 'center', lineHeight: 1.1 }}>We accept all credit cards.</span>
        </div>
        <div style={{
          width: '25%',
          display: 'flex',
          ...
          <span style={{ fontSize: 11, fontWeight: 600, color: '#222', lineHeight: 1.1, textAlign: 'center' }}>HELP CENTER</span>
          <span style={{ fontSize: 10, color: '#666', textAlign: 'center', lineHeight: 1.1 }}>Dedicated 10:30 - 18:00 support</span>
        </div>
      </div>
    </div>
  );
