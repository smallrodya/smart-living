    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: 11, fontWeight: 600, color: '#222', lineHeight: 1.1, textAlign: 'center' }}>24/7 HELP CENTER</span>
          <span style={{ fontSize: 10, color: '#666', textAlign: 'center', lineHeight: 1.1 }}>Dedicated 24/7 support</span>
        </div>
      </div>
    </div>
  );
