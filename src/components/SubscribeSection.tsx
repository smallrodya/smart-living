            ...
            <span
              ...
              style={{
                ...
                animation: titleVisible
                  ? `subscribeCharIn 0.8s cubic-bezier(0.23, 1, 0.32, 1) forwards ${i * 0.08 + 0.2}s`
                  : 'none',
          ...
          {titleVisible && (
            <div
              style={{
                ...
                animation: 'subscribeUnderline 1.2s ease-out 1.5s forwards',
              }}
            />
          )}
        </h2>
        <style>{`
          @keyframes subscribeCharIn {
            0% {
              opacity: 0;
