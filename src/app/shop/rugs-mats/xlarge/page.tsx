...
export default function XLargeRugsMatsPage() {
  ...
  const formatPriceRange = (product: Product) => {
    ...
    return xlargeSize.salePrice ? formatPrice(xlargeSize.salePrice) : formatPrice(xlargeSize.regularPrice);
  };
  ...
  const filteredProducts = products.filter(product => {
    ...
    const productPrice = xlargeSize?.salePrice || xlargeSize?.regularPrice || 0;
    ...
    <>
      ...
      <main>
        ...
        <div style={{
          ...
          <Image
            src="/xlarge-rugs-mats.jpg"
            alt="XLarge Rugs & Mats"
            fill
            style={{
              objectFit: 'cover',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Explore our collection of extra large rugs and mats, perfect for spacious rooms and grand entrances
              </p>
            </div>
          </div>
        </div>
