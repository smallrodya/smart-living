...
export default function PlainPage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const plainProducts = data.products.filter(
        (product: Product) => 
          product.category === 'BEDDING' && 
          product.beddingStyles?.includes('Plain')
      );
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Discover our elegant collection of plain bedding, featuring timeless designs and premium quality materials
              </p>
            </div>
          </div>
        </div>
