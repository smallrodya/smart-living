...
export default function FleeceThrowsTowelsPage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      console.log('Все продукты:', data.products);
      
      const throwsTowelsProducts = data.products.filter(
        (product: Product) => product.category === 'THROWS & TOWELS'
      );
      console.log('Продукты THROWS & TOWELS:', throwsTowelsProducts);
      
      const fleeceProducts = throwsTowelsProducts.filter(
        (product: Product) => product.subcategory === 'Fleece'
      );
      console.log('Продукты Fleece:', fleeceProducts);
      
      setProducts(fleeceProducts);
    } catch (error) {
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Experience ultimate comfort with our soft and warm fleece collection
              </p>
            </div>
          </div>
        </div>
