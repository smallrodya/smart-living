...
export default function HousewifePillowcasePage() {
    ...
    try {
      ...
      const pillowcases = data.products.filter(
        (product: Product) => 
          ...
          product.beddingStyles.includes('Housewife Pillowcase')
      );
    ...
    <>
      ...
      <main>
        ...
        <div style={{
          ...
          <Image
            src="/SHOPPILLOWCASEHousewifePillowcase.jpg"
            alt="Housewife Pillowcases"
            fill
            style={{
              objectFit: 'cover',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Discover our collection of premium housewife pillowcases, perfect for a comfortable and stylish sleep
              </p>
            </div>
          </div>
        </div>
