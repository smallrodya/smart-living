...
export default function OutdoorChairsPage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const outdoorChairsProducts = data.products.filter(
        (product: Product) => product.category === 'OUTDOOR' && product.subcategory === 'Chairs'
      );
      setProducts(outdoorChairsProducts);
    } catch (error) {
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Discover our premium outdoor chairs for your perfect outdoor living space
              </p>
            </div>
          </div>
        </div>
