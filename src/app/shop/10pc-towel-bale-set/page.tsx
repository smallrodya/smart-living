    ...
    try {
      ...
      const towelBaleSets = data.products.filter(
        (product: Product) => 
          ...
          product.subcategory === '10Pc Towel Bale Set') ||
          (product.additionalCategories && 
           product.additionalCategories.some(
             (ac: { category: string; subcategory: string }) => 
               ...
               ac.subcategory === '10Pc Towel Bale Set'
           ))
      );
    ...
    <>
      ...
      <main>
        ...
        <div style={{
          ...
          <Image
            src="/10pc-towel-bale-set.jpg"
            alt="10Pc Towel Bale Set"
            fill
            style={{
              objectFit: 'cover',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Complete your bathroom with our luxurious 10-piece towel sets
              </p>
            </div>
          </div>
        </div>
