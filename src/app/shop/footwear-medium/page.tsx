...
export default function FootwearMediumPage() {
    ...
    try {
      ...
      const filteredProducts = data.products.filter((product: Product) => {
        ...
        return product.category === 'FOOTWEAR' && 
               product.footwearSizes?.some(size => size.size === 'Medium');
      });
    ...
    <>
      ...
      <main>
        ...
        <div style={{
          ...
          <Image
            src="/medium-footwear.jpg"
            alt="Medium Collection"
            fill
            style={{
              objectFit: 'cover',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Discover our collection of footwear in Medium size
              </p>
            </div>
          </div>
        </div>
