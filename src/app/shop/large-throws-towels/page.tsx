...
export default function LargeThrowsTowelsPage() {
    ...
    try {
      ...
      const filteredProducts = data.products.filter((product: Product) => {
        ...
        return product.category === 'THROWS & TOWELS' && 
               (product.throwsTowelsStyles?.includes('Large') || 
                product.throwsTowelsStylePrices?.some(style => style.size === 'Large'));
      });
    ...
    <>
      ...
      <main>
        ...
        <div style={{
          ...
          <Image
            src="/large-throws-towels.jpg"
            alt="Large Throws & Towels"
            fill
            style={{
              objectFit: 'cover',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Discover our collection of large throws and towels
              </p>
            </div>
          </div>
        </div>
