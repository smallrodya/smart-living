...
export default function FootwearUK78Page() {
    ...
    try {
      ...
      const filteredProducts = data.products.filter((product: Product) => {
        ...
        return product.category === 'FOOTWEAR' && 
               product.footwearSizes?.some(size => size.size === 'UK 7-8');
      });
      ...
      try {
        ...
        const validItems = Array.isArray(existingItems) 
          ? existingItems.filter(item => 
              ...
              !item.id.startsWith('uk78_')
            )
          : [];
        
        const newItems = products
          .filter((p) => newWishlist.includes(`uk78_${p._id}`))
          .map((item) => ({
            id: `uk78_${item._id}`,
            src: item.images?.[0] || '',
    ...
    <>
      ...
      <main>
        ...
        <div style={{
          ...
          <Image
            src="/uk78-footwear.jpg"
            alt="UK 7-8 Collection"
            fill
            style={{
              objectFit: 'cover',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Discover our collection of footwear in UK sizes 7-8
              </p>
            </div>
          </div>
        </div>
                  ...
                  >
                    <button
                      ...
                      style={{
                        ...
                        transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                        transform: wishlist.includes(`uk78_${product._id}`) ? 'scale(1.1)' : 'scale(1)',
                        backdropFilter: 'blur(4px)'
                      }}
                    >
                      <svg
                        ...
                        height="20"
                        viewBox="0 0 24 24"
                        fill={wishlist.includes(`uk78_${product._id}`) ? '#e53935' : 'none'}
                        stroke="#e53935"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
