...
export default function FootwearLargePage() {
    ...
    try {
      ...
      const filteredProducts = data.products.filter((product: Product) => {
        ...
        return product.category === 'FOOTWEAR' && 
               product.footwearSizes?.some(size => size.size === 'Large');
      });
    ...
    <>
      ...
      <main>
        ...
        <div style={{
          ...
          <Image
            src="/large-footwear.jpg"
            alt="Large Collection"
            fill
            style={{
              objectFit: 'cover',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Discover our collection of footwear in Large size
              </p>
            </div>
          </div>
        </div>
