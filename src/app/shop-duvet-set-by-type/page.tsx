...
export default function ShopDuvetSetByType() {
    ...
    <>
      ...
      <main>
        ...
        <div style={{
          ...
          <Image
            src="/cat-bedding-main.jpg"
            alt="Duvet Sets Category"
            fill
            style={{
              objectFit: 'cover',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Discover our collection of premium duvet sets, perfect for creating a cozy and stylish bedroom
              </p>
            </div>
          </div>
        </div>
