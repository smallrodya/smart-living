                  ...
                  <div className="flex items-center justify-center">
                    <button
                      ...
                      onClick={async () => {
                        ...
                        // Additional Apple Pay diagnostics
                        ...
                        console.log('- Is macOS:', navigator.platform.includes('Mac'));
                        console.log('- Has Apple Pay capability:', 'ApplePaySession' in window);
                        ...
                        try {
                          ...
                          console.log('All available methods:', result);
                          ...
                          // Try alternative Apple Pay detection
                          if (!result || !result.applePay) {
                            console.log('Trying alternative Apple Pay detection...');
