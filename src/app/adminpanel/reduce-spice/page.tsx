...
export default function ReduceSpiceSection() {
  const { sectionTitle, sectionDescription, products, updateSectionTitle, updateSectionDescription, updateProduct, deleteProduct } = useReduceSpace();
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6">Edit Reduce Space Section</h1>
