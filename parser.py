...
def parse_premium_duvet_sets():
    base_url = "https://smart-living.co.uk/category/rugs/rugtype/shaggy-rugs/"
    headers = {
    ...
    with open('Shaggy Rugs_products.json', 'w', encoding='utf-8') as f:
        json.dump(products, f, ensure_ascii=False, indent=2)
        
    print(f"\nВсего спарсено товаров: {len(products)}")
    print("Результаты сохранены в файл Shaggy Rugs_products.json")
    
    if len(products) != 22:
        print(f"\nВНИМАНИЕ: Спарсено {len(products)} товаров вместо ожидаемых 22!")
